...
export default function ContractForm({ defaultValues, clients, onSubmit, submitLabel = 'Save Contract' }: Props) {
    ...
    <form onSubmit={handleSubmit}>
      <Card className="p-6 space-y-5 max-w-3xl">
        <div className="grid grid-cols-2 gap-4">
          <Input label="Contract Name" value={form.name} onChange={(e) => set('name', e.target.value)} placeholder="Contract name" required />
          <Input label="Code" value={form.code} onChange={(e) => set('code', e.target.value)} placeholder="ΣΥΝΛ-00000149/2025/00" required />
        </div>
