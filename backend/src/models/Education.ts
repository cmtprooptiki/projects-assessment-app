...
export interface EducationCreationAttributes
  extends Optional<EducationAttributes, 'id' | 'schoolName' | 'departmentName' | 'specialization' | 'dateAwarded' | 'recognized' | 'degreeType'> {}
...
Education.init(
  {
    ...
    schoolName: { type: DataTypes.STRING(300), allowNull: true, defaultValue: null },
    departmentName: { type: DataTypes.STRING(300), allowNull: true, defaultValue: null },
